...
if __name__=="__main__":
        ...
        if args.style == 'grid':
                scv.pl.velocity_embedding_grid(adata, vkey = velocity_key, save = args.output, dpi = args.dpi, color = args.color, palette = colour_list, components = args.components, show = False)
        elif args.style == 'stream':
                scv.pl.velocity_embedding_stream(adata, vkey = velocity_key, save = args.output, dpi = args.dpi, color = args.color, palette = colour_list, components = args.components, show = False)
